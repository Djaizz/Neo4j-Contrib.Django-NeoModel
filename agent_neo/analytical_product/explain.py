...
def explain_lineage_from_cache_key(
    ...
    *,
    ...
    RETURN root.cache_key AS cache_key,
           ...
           root.temporal_granularity AS temporal_granularity,
    ...
    RETURN root.cache_key AS root_cache_key,
           ...
           dependent.temporal_granularity AS dependent_granularity,
    ...
    nodes_by_cache_key: dict[str, dict[str, Any]] = {
        str(root_cache_key): {
            ...
            'temporal_granularity': root_granularity,
